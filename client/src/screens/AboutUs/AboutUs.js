    ...
    <div>
        <div className="team-one">
            <div className="team-container">
                <img src="https://i.imgur.com/y8cYLSa.jpg" className="aboutUs-image-left" alt="jeff"/>
        ...
        <div className="team-two">
            <div className="team-container">
                ...
                <img src="https://i.imgur.com/JvLCSj6.jpg" className="aboutUs-image-right" alt="terra"/>
            </div>
        </div>
        <div className="team-one">
            <div className="team-container">
                <img src="https://i.imgur.com/OYGL0a5.jpg" className="aboutUs-image-left" alt="julia"/>
                <div className="title-info">
        ...
        <div className="team-two">
            <div className="team-container">
                ...
                <img src="https://i.imgur.com/dmJIsq6.png" className="aboutUs-image-right" alt="clint"/>
            </div>
        </div>
        <div className="team-one">
            <div className="team-container">
                <img src="https://i.imgur.com/oWTgaZc.jpg" className="aboutUs-image-left"alt="lance"/>
                <div className="title-info">
